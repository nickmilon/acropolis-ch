...
export const coreTypes = {
  // prior to ch adopting bool types Bool : { min: false, max: true, toJS: (val) => val === 1, fromJS: (val) => val | 0 },                                                // synonym to Int8;
  Bool: { min: false, max: true, toJS: dummyFn, fromJS: dummyFn },
...
export const extendedTypes = {
   ...
   * @param  {any} typesOfArguments see {@link https://clickhouse.com/docs/en/sql-reference/data-types/aggregatefunction/ AggregateFunction}
